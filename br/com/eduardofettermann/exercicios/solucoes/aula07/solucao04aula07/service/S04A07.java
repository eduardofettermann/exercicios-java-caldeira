package br.com.eduardofettermann.exercicios.solucoes.aula07.solucao04aula07.service;

import br.com.eduardofettermann.exercicios.model.Solucao;
import br.com.eduardofettermann.exercicios.solucoes.aula07.solucao04aula07.model.Calculator;
import br.com.eduardofettermann.exercicios.solucoes.aula07.solucao04aula07.model.Operation;

import java.util.InputMismatchException;

import static br.com.eduardofettermann.exercicios.solucoes.aula07.solucao04aula07.model.Operation.*;
...
public class S04A07 implements Solucao {
    ...
    private void showMenu() {
        ...
        switch (nextInt) {
            case (1) -> showOperationMenu(ADICAO);
            case (2) -> showOperationMenu(SUBTRACAO);
            case (3) -> showOperationMenu(MULTIPLICACAO);
            case (4) -> showOperationMenu(DIVISAO);
